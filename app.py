...
st.title("🏥 AI Medical Report Summarizer (Free)")
...
def analyze_medical_report(uploaded_file):
    ...
    Return strictly in valid JSON format with keys: patient_name, test_date, abnormal_findings, summary, recommendations.
    """
